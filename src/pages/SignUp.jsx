    ...
    <AuthLayout>
      <div className="flex h-full flex-col">
        <div className="space-y-4 text-center md:text-left">
          ...
          <h1 className="text-3xl font-bold text-[#232323] md:text-4xl">Sign up</h1>
          <p className="text-[#969696] md:text-lg">Sign up to enjoy the feature of HD</p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <SubmitButton type="submit">{otpSent ? 'Sign up' : 'Get OTP'}</SubmitButton>
        </form>
        ...
        <GoogleSignInButton />
        <p className="mt-auto pt-8 text-center text-sm text-[#6C6C6C] md:text-base">Already have an account?{' '}<Link to="/signin" className="font-medium text-[#367AFF] hover:underline">Sign in</Link></p>
      </div>
    </AuthLayout>
  );
}